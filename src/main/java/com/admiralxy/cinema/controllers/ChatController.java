...
import com.admiralxy.cinema.dto.MessageCreateDTO;
import com.admiralxy.cinema.dto.MessageDTO;
...
public class ChatController {
    ...
    public ModelAndView index(@PathVariable("id") Long id, @ModelAttribute("model") ModelMap model) {
        ...
        model.addAttribute("messages", MessageDTO.fromEntities(this.messagesService.findByFilmId(id)));
    ...
    public MessageDTO send(@DestinationVariable String id, MessageCreateDTO message) {
        Message createdMessage = this.messagesService.save(message.toEntity());
        return MessageDTO.fromEntity(createdMessage);
    }
}
